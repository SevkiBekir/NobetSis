                ...
                <div class="sign-in-form">
                    ...
                    <div class="signin">
                        <div class="sign-in-form-top">
                            <p><span>NöbetSis</span> <a href="#"> Kayıt</a></p>
                        </div>
                        ...
                        <form action="register" method="post">
                            <div class="log-input">
                                <div class="log-input-center">
                                    <input type="text" class="user" name="txbFName" value="<?=set_value('txbFName');?>" placeholder="İsim" required/>
                                </div>
                                <div class="clearfix"> </div>
                            </div>
                            <div class="log-input">
                                <div class="log-input-center">
                                    <input type="text" class="user" name="txbLName" value="<?=set_value('txbLName');?>" placeholder="Soyisim" required/>
                                </div>
                                <div class="clearfix"> </div>
                            </div>
                            <div class="log-input">
